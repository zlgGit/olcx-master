...
public class CcNoneHeader extends RelativeLayout implements RefreshHeader {
    ...
    public CcNoneHeader(Context context) {
        super(context);
        this.initView(context, null);
    }

    public CcNoneHeader(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.initView(context, attrs);
    }

    public CcNoneHeader(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        this.initView(context, attrs);
    }

    @RequiresApi(Build.VERSION_CODES.LOLLIPOP)
    public CcNoneHeader(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void initView(Context context, AttributeSet attrs) {
        ...
        if (ta.hasValue(com.scwang.smartrefresh.layout.R.styleable.ClassicsHeader_srlTextSizeTitle)) {
            mTitleText.setTextSize(ta.getDimensionPixelSize(com.scwang.smartrefresh.layout.R.styleable.ClassicsHeader_srlTextSizeTitle, 16));
        } else {
            mTitleText.setTextSize(16);
        }

        if (ta.hasValue(com.scwang.smartrefresh.layout.R.styleable.ClassicsHeader_srlTextSizeTime)) {
            mLastUpdateText.setTextSize(ta.getDimensionPixelSize(com.scwang.smartrefresh.layout.R.styleable.ClassicsHeader_srlTextSizeTime, 12));
        } else {
...
//    }
    ...
    public CcNoneHeader setProgressBitmap(Bitmap bitmap) {
        mProgressDrawable = null;
        mProgressView.setImageBitmap(bitmap);
        return this;
    }
    public CcNoneHeader setProgressDrawable(Drawable drawable) {
        mProgressDrawable = null;
        mProgressView.setImageDrawable(drawable);
        return this;
    }
    public CcNoneHeader setProgressResource(@DrawableRes int resId) {
        mProgressDrawable = null;
        mProgressView.setImageResource(resId);
        return this;
    }
    public CcNoneHeader setArrowBitmap(Bitmap bitmap) {
        mArrowDrawable = null;
        mArrowView.setImageBitmap(bitmap);
        return this;
    }
    public CcNoneHeader setArrowDrawable(Drawable drawable) {
        mArrowDrawable = null;
        mArrowView.setImageDrawable(drawable);
        return this;
    }
    public CcNoneHeader setArrowResource(@DrawableRes int resId) {
        mArrowDrawable = null;
        mArrowView.setImageResource(resId);
        return this;
    }

    public CcNoneHeader setLastUpdateTime(Date time) {
        mLastTime = time;
    ...
    public CcNoneHeader setTimeFormat(DateFormat format) {
        mFormat = format;
        mLastUpdateText.setText(mFormat.format(mLastTime));
        return this;
    }

    public CcNoneHeader setSpinnerStyle(SpinnerStyle style) {
        this.mSpinnerStyle = style;
        return this;
    }

    public CcNoneHeader setPrimaryColor(int primaryColor) {
    ...
    public CcNoneHeader setAccentColor(int accentColor) {
    ...
    public CcNoneHeader setFinishDuration(int delay) {
        mFinishDuration = delay;
        return this;
    }

    public CcNoneHeader setEnableLastTime(boolean enable) {
    ...
    public CcNoneHeader setTextSizeTitle(float size) {
    ...
    public CcNoneHeader setTextSizeTitle(int unit, float size) {
    ...
    public CcNoneHeader setTextSizeTime(float size) {
    ...
    public CcNoneHeader setTextSizeTime(int unit, float size) {
    ...
    public CcNoneHeader setTextTimeMarginTop(float dp) {
        return setTextTimeMarginTopPx(DensityUtil.dp2px(dp));
    }

    public CcNoneHeader setTextTimeMarginTopPx(int px) {
    ...
    public CcNoneHeader setDrawableMarginRight(float dp) {
        return setDrawableMarginRightPx(DensityUtil.dp2px(dp));
    }

    public CcNoneHeader setDrawableMarginRightPx(int px) {
    ...
    public CcNoneHeader setDrawableSize(float dp) {
        return setDrawableSizePx(DensityUtil.dp2px(dp));
    }

    public CcNoneHeader setDrawableSizePx(int px) {
    ...
    public CcNoneHeader setDrawableArrowSize(float dp) {
        return setDrawableArrowSizePx(DensityUtil.dp2px(dp));
    }

    public CcNoneHeader setDrawableArrowSizePx(int px) {
        ViewGroup.LayoutParams lpArrow = mArrowView.getLayoutParams();
        lpArrow.width = px;
        lpArrow.height = px;
        mArrowView.setLayoutParams(lpArrow);
    ...
    public CcNoneHeader setDrawableProgressSize(float dp) {
        return setDrawableProgressSizePx(DensityUtil.dp2px(dp));
    }

    public CcNoneHeader setDrawableProgressSizePx(int px) {
        ViewGroup.LayoutParams lpProgress = mProgressView.getLayoutParams();
        lpProgress.width = px;
